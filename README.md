...
bcos-sdk-jni is an implementation of the JNI interface of [FISCO BCOS 3.0](https://github.com/FISCO-BCOS/FISCO-BCOS), encapsulating the basic interface of bcos-c-sdk for java-sdk.
