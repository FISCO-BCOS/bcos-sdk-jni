 ...
 * Method:    build
 * Signature: (Ljava/lang/String;Lorg/fisco/bcos/sdk/jni/common/ConfigOption;)Lorg/fisco/bcos/sdk/jni/rpc/Rpc;
 */
JNIEXPORT jobject JNICALL Java_org_fisco_bcos_sdk_jni_rpc_Rpc_build
